const canvas = document.getElementById('flowingBlobsCanvas') as HTMLCanvasElement;
const ctx = canvas.getContext('2d');

// --- SETTINGS ---
const numberOfBlobs: number = 10;       // Number of blobs
const minBlobRadius: number = 30;      // Minimum blob radius
const maxBlobRadius: number = 70;      // Maximum blob radius
const minBlobSpeed: number = 0.2;     // Minimum movement speed
const maxBlobSpeed: number = 0.8;     // Maximum movement speed
const baseColorHue: number = 220;      // Base hue for the color (bluish)
const hueVariation: number = 30;       // Variation in hue
const colorSaturation: number = 70;    // Color saturation
const colorLightness: number = 60;    // Color lightness
const opacity: number = 0.6;           // Base opacity of the blobs
const blurAmount: number = 10;         // Amount of blur to create soft edges
// --- END SETTINGS ---
